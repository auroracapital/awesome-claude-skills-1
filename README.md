...
| **[upres-upscaler](https://github.com/auroracapital/upres.ai)** | AI image and video upscaling to 8K resolution across 14 neural models with batch processing and MCP server |
