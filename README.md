...
| **[upres-upscaler](https://github.com/auroracapital/upres-cli)** | AI image and video upscaling to 8K resolution across 14 public model aliases with batch processing and MCP server |
